...
import { updateBlog } from '../../../services/updateBlogService';
...
const UpdateBlog = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const responseData = await updateBlog(formData);
                    ...
                    <Col md={6}>
                        <Form>
                            ...
                            <Form.Group controlId="formImage1">
                                ...
                                <Form.Control type="text" placeholder="Enter Image 1" value={img1} onChange={(e) => setImage1(e.target.value)} />
                            </Form.Group>
                    ...
                    <Col md={6}>
                        <Form>
                            ...
                            <Form.Group controlId="formImage2">
                                ...
                                <Form.Control type="text" placeholder="Enter Image 2" value={img2} onChange={(e) => setImage2(e.target.value)} />
                            </Form.Group>
