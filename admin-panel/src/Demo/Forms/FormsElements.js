...
import CreateBlog from '../../App/components/wof-form/createBlog';
import UpdateBlog from '../../App/components/wof-form/updateBlog';
import DeleteForm from '../../App/components/wof-form/deleteForm';
...
function FormsElements() {
    ...
    async function UpdateData() {
        ...
        var response = await fetch(`https://confused-erin-tam.cyclic.app/UpdateData/${ID}`, {
            method: "PUT",
            body: JSON.stringify({
                name: name1, image: image1, bannerimage: Bannerimage1, description: Description1, categories: Categories1, episodes: [{
    ...
    async function CreateData() {
        ...
        // console.log(name," ",SignupEmail," ",SignupPassword)
        var response = await fetch("https://confused-erin-tam.cyclic.app/PostData", {
            method: "POST",
            body: JSON.stringify({
                name: name, image: image, bannerimage: Bannerimage, description: Description, categories: Categories, episodes: [{
